    ...
    <div className="page-wrapper">
      ...
      <div className="content-container page-padding" style={{ paddingBottom: '100px' }}>
        ...
        <div className="services-grid responsive-grid">
          {[
            { title: 'Airport Transfers', icon: <Plane size={40} />, desc: 'Luxury door-to-door transfers with fixed pricing and 24/7 reliability.', path: '/services/airport-transfer' },
            { title: 'Intercity Transfers', icon: <Car size={40} />, desc: 'Safe and reliable long-distance travel across the North Island.', path: '/services/intercity-transfer' },
            ...
            <motion.div 
              ...
              style={{ padding: '3rem 2rem', textAlign: 'center', cursor: s.path ? 'pointer' : 'default' }}
            ...
            >
              ...
              <p style={{ color: 'var(--text-muted)', lineHeight: '1.6', marginBottom: s.path ? '1.5rem' : '0' }}>{s.desc}</p>
              {s.path && (
