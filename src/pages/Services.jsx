        ...
        <div className="services-grid responsive-grid">
          {[
            ...
            <motion.div 
              ...
              style={{ padding: '3rem 2rem', textAlign: 'center', cursor: (s.path || s.isBooking || s.contactCta || s.toursLink) ? 'pointer' : 'default' }}
            ...
            >
              ...
              <p style={{ color: 'var(--text-muted)', lineHeight: '1.6', marginBottom: '1.5rem' }}>{s.desc}</p>
              {s.isBooking && (
              ...
              {s.contactCta && (
                <div style={{ color: 'var(--primary-color)', fontWeight: 700, fontSize: '0.9rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }}>
                  {s.contactCta} <Users size={16} />
                </div>
              )}
              {s.toursLink && (
                <div style={{ color: 'var(--primary-color)', fontWeight: 700, fontSize: '0.9rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }}>
                  View Our Fleet <Shield size={16} />
                </div>
              )}
            </motion.div>
          ))}
