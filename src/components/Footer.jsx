    ...
    <footer className="footer footer-static" style={{ borderRadius: '2rem 2rem 0 0', marginTop: '4rem' }}>
      <div className="footer-content">
        ...
        <div className="footer-section">
          <h4>Contact Us</h4>
          <ul className="footer-links">
            <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}><Mail size={16} /> {settings.contactEmail}</li>
            <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}><Phone size={16} /> {settings.contactPhone}</li>
            <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}><MapPin size={16} /> {settings.contactAddress}</li>
          </ul>
        </div>
      </div>

      <div className="footer-bottom">
        <p>&copy; {new Date().getFullYear()} {settings.siteTitle} NZ. All rights reserved.</p>
